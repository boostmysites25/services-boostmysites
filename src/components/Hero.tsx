...
const Hero = memo(() => {
  ...
  return (
    ...
    >
      ...
      >
        <source
          src="https://res.cloudinary.com/dknafpppp/video/upload/v1748771996/0_Ai_Brain_1920x1080_quggeb.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div
        className="relative z-20 container mx-auto px-6 pb-24 pt-28"
        style={{
          contain: "layout style paint",
        }}
      >
