...
import { SalespersonLink, salespersonLinkService, AVAILABLE_SERVICES } from '@/services/salespersonLinkService';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-200 mt-2 text-lg">
              Create personalized landing pages with automatic lead capture and routing
            </p>
          </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-gray-800/30 rounded-lg">
                    ...
                    <div>
                      <h5 className="font-semibold text-blue-400 text-sm">Increased Conversion</h5>
                                             <p className="text-xs text-gray-300 mt-1">Personalized experience drives higher engagement</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-800/30 rounded-lg">
                    ...
                    <div>
                      <h5 className="font-semibold text-green-400 text-sm">Lead Tracking</h5>
                                             <p className="text-xs text-gray-300 mt-1">Automatic attribution and source tracking</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-800/30 rounded-lg">
                    ...
                    <div>
                      <h5 className="font-semibold text-purple-400 text-sm">Brand Consistency</h5>
                                             <p className="text-xs text-gray-300 mt-1">Service-specific colors and branding</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-2 max-h-64 overflow-y-auto">
                  {AVAILABLE_SERVICES.map((service) => (
                    <div key={service.id} className="flex items-center gap-3 p-2 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors">
