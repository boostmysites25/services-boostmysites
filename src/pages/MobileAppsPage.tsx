          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-50">
              <Link
                ...
                smooth
                offset={-100}
                className="cursor-pointer px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl font-semibold hover:from-purple-400 hover:to-pink-500 transition-all duration-300 transform hover:scale-105 relative z-50"
              >
                Start Development
              </Link>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-500/10 to-pink-500/10 relative">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <Link
            ...
            smooth
            offset={-100}
            className="cursor-pointer inline-block px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl font-semibold hover:from-purple-400 hover:to-pink-500 transition-all duration-300 transform hover:scale-105 relative z-50"
          >
            Get Started
          </Link>
        </div>
